...
public class CursoMapper {
    ...
    public CursoAlunoRespostaDTO CursoAlunoRespostaDTO(Curso curso){
        List<AlunoRespostaDTO> alunos = curso.getAlunos()
                                             .stream()
                                             .map(mapper::EntidadeParaDTO)
                                             .toList();

        CursoRespostaDTO cursoResp = EntidadeParaDTO(curso);

        return new CursoAlunoRespostaDTO(cursoResp, alunos);
    }
