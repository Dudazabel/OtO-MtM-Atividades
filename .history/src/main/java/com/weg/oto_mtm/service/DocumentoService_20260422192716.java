...
public class DocumentoService {
    ...
    public DocumentoRespostaDTO cadastrarDocumento(DocumentoRequisicaoDTO documento){
        
        Documento documentoVerificar = repository.findByNumero(!documento.numero())
        .orElseThrow(() -> new RuntimeException("Documento já existe"));
    }
